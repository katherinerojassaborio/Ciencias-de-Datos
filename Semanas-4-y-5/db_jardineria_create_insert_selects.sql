--Comando para borrar la base de datos si existe
...
--Comando para crear la tabla oficina
...
--Comando para crear la tabla gama_producto
...
--Este es un ejemplo de inserción a la tabla oficina
...
--Este es un ejemplo de inserción a la tabla empleado
...
--Este es un ejemplo de inserción a la tabla gama producto
...
--Este es un ejemplo de inserción a la tabla cliente
...
--Este es un ejemplo de inserción a la tabla pedido
...
--Este es un ejemplo de inserción a la tabla producto
...
--Este es un ejemplo de inserción a la tabla detalle_pedido
...
--Este es un ejemplo de inserción a la tabla pago
...
--QUERIES
--Devuelve un listado con el código de oficina y ciudad
SELECT codigo_oficina, ciudad
FROM oficina;
GO

--Revisar los jefes que tengan un código nulo
SELECT nombre, codigo_jefe
FROM empleado;
GO

--Devuelve un listado con la ciudad y el telefóno de las oficinas de España
